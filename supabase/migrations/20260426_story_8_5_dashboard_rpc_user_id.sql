-- Migration: rpc_dashboard_summary — add p_user_id parameter
-- Filters all member-scoped data (accounts, budgets, transactions) by p_user_id.
-- Categories remain unfiltered (shared household data).
...
GRANT EXECUTE ON FUNCTION rpc_dashboard_summary(date, uuid) TO authenticated;
