...
import { ExpenseTypesList } from '@/components/expense-types/expense-types-list'
...
export default async function ExpenseTypesPage() {
  ...
  const { data: expenseTypes } = await adminClient
    .from('expense_types')
    .select('*')
    .order('name')
    ...
    <WorkspaceShell>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          <Link href="/app/expense-types/new">
            <Button>
        ...
        <Card>
          ...
          <CardContent>
            <ExpenseTypesList expenseTypes={expenseTypes || []} />
          </CardContent>
        </Card>
      </div>
    </WorkspaceShell>
