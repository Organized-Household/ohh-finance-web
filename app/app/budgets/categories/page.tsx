        ...
        <section className="rounded-xl border bg-white p-5 shadow-sm">
          ...
          >
            ...
            <div className="md:col-span-4 rounded-lg bg-gray-50 p-3 text-sm text-gray-600">
              ...
              <p className="mt-1">
                <span className="font-medium">Tag</span> helps organize
                categories such as standard, savings, or investment.
              </p>
            </div>
        ...
        <div className="grid gap-6 xl:grid-cols-2">
          {typeOrder.map((type) => (
            ...
            >
              ...
              {!grouped[type].length ? (
                <p className="text-sm text-gray-600">No {type} categories yet.</p>
              ) : (
